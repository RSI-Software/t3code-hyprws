...
export class DesktopRendererAssetsUnavailableError extends Schema.TaggedError<DesktopRendererAssetsUnavailableError>()(
  ...
  if (backendMode === "client-only") {
    if (environment.isDevelopment) {
      yield* electronProtocol.registerDesktopProtocol({
        ...
        backendOrigin: Option.getOrThrow(environment.devServerUrl),
