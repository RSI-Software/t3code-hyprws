...
import { ModelSelection, ThreadCheckoutMove, ThreadLinkedPullRequest } from "@t3tools/contracts";
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.branch},
          ${row.worktreePath},
          ${row.checkoutMove ? JSON.stringify(row.checkoutMove) : null},
        ...
        DO UPDATE SET
          ...
          checkout_move_json = excluded.checkout_move_json,
