...
vi.mock("../state/pullRequests", () => {
  ...
  return {
    ...
    // The page keys its refetches off this; the route-identity cases never turn, so an empty
    // revision list keeps the token stable instead of driving a refresh they do not assert.
