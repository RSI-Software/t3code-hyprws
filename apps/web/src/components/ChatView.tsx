...
function ChatViewContent(props: ChatViewProps) {
  ...
  const issueServerConfig =
    activeRightPanelSurface?.kind === "github-issue"
      ? (environmentById.get(activeRightPanelSurface.environmentId as EnvironmentId)
          ?.serverConfig ?? null)
      : null;
              ...
              >
                <div className="group/composer-stack pointer-events-auto relative z-10">
                  ...
                  >
                    ...
                    >
                      <div className="chat-composer-glass-host relative z-10 w-full rounded-[22px] sm:focus-within:ring-1 sm:focus-within:ring-ring">
