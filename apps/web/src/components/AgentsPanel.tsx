  ...
  return (
    ...
    >
      <header className="flex items-center gap-2 border-b border-border/60 px-2 py-2">
        ...
        {/* fork-hook: custom-agents/agent-activity-read-only-badge */}
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-2 p-6 text-center">
        ...
        {/* fork-hook: custom-agents/agent-activity-agent-id */}
        <code className="max-w-72 break-all text-3xs text-muted-foreground/70">{agentId}</code>
        {/* fork-hook-end */}
      </div>
    </div>
  );
