...
- Every action taken from the churn ledger ships the guard that stops its recurrence; read the hot seams in the `vp run fork:scan` output before touching a file they name.
