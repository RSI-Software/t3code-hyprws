...
| `apps/server/src/orchestration/Layers/ProjectionPipeline.ts`                                                 | Carries those move fields through projection.                                                                                                                                                                  |
...
| `packages/client-runtime/src/state/threadDetail.ts`                                                          | Carries `checkoutMove` onto merged environment threads.                                                                                                                                                        |
