...
| feat(web): add manual sidebar thread ordering                                  | thread-ordering  | Upstream sidebar work does not provide durable manual ordering or grouping.                                                                                                                    | v0.0.37-nightly.20260829.1224 |
