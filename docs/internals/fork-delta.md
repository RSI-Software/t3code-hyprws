...
| `apps/server/src/orchestration/Services/ProjectionSnapshotQuery.ts`, `apps/server/src/orchestration/Layers/ProjectionSnapshotQuery.ts`                                                                                                                                                                                                           | `getAgentActivitySnapshot` is a fork member of the query shape.                                           |
| `apps/server/src/serverRuntimeStartup.test.ts`, `apps/server/src/project/AgentSessionScanner.test.ts`, `apps/server/src/project/ProjectSetupScriptRunner.test.ts`, `apps/server/src/provider/Layers/ProviderSessionReaper.test.ts`                                                                                                               | Upstream literals of that shape; a new one arrives without the fork member and only typecheck catches it. |
...
| `apps/web/src/components/ThreadTerminalDrawer.tsx`, `apps/web/src/components/ThreadTerminalDrawer.test.ts` | Surface and browser/Electron window demand determine attachment leases.                                                             |
