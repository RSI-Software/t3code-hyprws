...
| fix(provider): resolve repo skills per workspace (#188)                        | upstream-fixes   | Composer and provider overlap did not supply workspace-relative repository skill resolution.                                                                                                   | v0.0.37-nightly.20260829.1224 |
